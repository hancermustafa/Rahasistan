...
# =============================================================================
# 1. GÖRSEL TASARIM (PREMIUM UI - DEĞİŞMEDİ)
# =============================================================================
def local_css():
    st.markdown("""
    <style>
    ...
    .header-container {
        ...
        padding: 1.5rem; border-radius: 15px; color: white !important;
        box-shadow: 0 8px 20px rgba(0,0,0,0.15); margin-bottom: 20px;
        border-bottom: 5px solid #e67e22; gap: 20px;
    }
    .header-logo {
        width: 85px; height: 85px; border-radius: 50%;
        border: 3px solid rgba(255,255,255,0.8); object-fit: cover;
        background-color: white; flex-shrink: 0;
    }
    .header-text-block { display: flex; flex-direction: column; align-items: flex-start; }
    .header-title {
        font-size: 1.9rem; font-weight: 800; margin: 0; color: white !important;
        text-shadow: 1px 1px 3px rgba(0,0,0,0.3); line-height: 1.1;
    }
    .header-subtitle {
        font-size: 1.1rem; color: #f1f2f6 !important; margin-top: 3px;
        opacity: 0.95; font-weight: 500; letter-spacing: 0.5px;
    }

    /* PROTOKOL KUTUSU (TURKUAZ) */
    .protocol-box {
        background-color: #E0F2F1 !important; border: 2px solid #009688 !important;
        border-radius: 12px; padding: 15px; color: #004D40 !important;
        font-family: 'Courier New', monospace; font-weight: 600; font-size: 0.95rem;
        white-space: pre-wrap; margin-bottom: 10px; box-shadow: inset 0 2px 5px rgba(0,0,0,0.05);
    }
    ...
    .whatsapp-btn {
        ...
        text-align: center; margin-top: 10px; box-shadow: 0 4px 6px rgba(0,0,0,0.1); transition: all 0.2s;
    }
    ...
    div[role="radiogroup"] label {
        background-color: white; padding: 5px 15px; border-radius: 20px;
    ...
    li[role="option"] { color: #333 !important; background-color: #ffffff !important; border-bottom: 1px solid #f9f9f9; padding: 12px 15px !important; }
    ...
    .disease-card { background: white; border: 1px solid #eee; border-left: 6px solid #e67e22; padding: 20px; border-radius: 10px; margin-bottom: 20px; }
    ...
    @media only screen and (max-width: 600px) {
        .header-container { flex-direction: column; padding: 1.2rem; text-align: center; gap: 10px; }
        .header-text-block { align-items: center; }
...
# =============================================================================
# 2. VERİTABANI (YENİLER DAHİL TAM LİSTE)
# =============================================================================
def get_rah_database():
    db = {
        # --- YENİ EKLENENLER (v38) ---
        "Gluten İntoleransı (Çölyak)": {
            "source": "RAH 35.32 + Ulrich 4.07",
            "desc": "Gluten hassasiyeti ve ince bağırsak desteği.",
            "direct": ["35.32"],
            "compact": ["00.00", "01.00", "02.00", "31.10", "34.00", "35.10", "35.32", "46.40", "31.50", "01.00"],
            "ulrich": [{"code": "4.07", "name": "Asidoz (Bağırsak)"}]
        },
        "Laktoz İntoleransı": {
            "source": "RAH 35.31",
            "desc": "Süt şekeri sindirim sorunu.",
            "direct": ["35.31"],
            "compact": ["00.00", "01.00", "02.00", "31.10", "34.00", "35.10", "35.31", "46.40", "31.50", "01.00"],
            "ulrich": [{"code": "4.14", "name": "Temizleme"}]
        },
        "Siyatik (Sciatica)": {
            "source": "RAH 54.30 + Ulrich 4.21",
            "desc": "Siyatik sinir sıkışması ve bacak ağrısı.",
            "direct": ["54.30"],
            "compact": ["00.00", "01.00", "02.00", "31.40", "53.83", "54.30", "54.10", "71.50", "31.50", "01.00"],
            "ulrich": [{"code": "4.21", "name": "Sırt Ağrısı"}]
        },
        "PMS (Adet Öncesi Sendromu)": {
            "source": "RAH 65.50 + Ulrich 4.08",
            "desc": "Adet öncesi gerginlik ve ödem.",
            "direct": ["65.50"],
            "compact": ["00.00", "01.00", "02.00", "31.10", "65.10", "65.50", "50.00", "72.00", "31.50", "01.00"],
            "ulrich": [{"code": "4.08", "name": "Kadın Hormonları"}]
        },
        "İktidarsızlık (Erektil Disfonksiyon)": {
            "source": "RAH 68.40 + Ulrich 4.09",
            "desc": "Potans sorunları ve dolaşım desteği.",
            "direct": ["68.40"],
            "compact": ["00.00", "01.00", "02.00", "31.10", "64.00", "65.20", "68.40", "39.10", "31.50", "01.00"],
            "ulrich": [{"code": "4.09", "name": "Erkek Hormonları"}]
        },

        # --- MEVCUT TAM LİSTE ---
        "Adet Sancıları (Dismenore)": {"source": "RAH 65.40", "desc": "Ağrılı adet görme.", "direct": ["65.40"], "compact": ["00.00", "01.00", "02.00", "31.10", "64.00", "65.10", "65.40", "53.83", "31.50", "01.00"], "ulrich": [{"code": "4.08", "name": "Kadın Hormonları"}]},
        "Ağır Metal Detoksu": {"source": "RAH + Ulrich", "desc": "Ağır metal atılımı.", "direct": ["31.60", "31.50"], "compact": ["00.00", "01.00", "02.00", "31.10", "31.50", "31.60", "31.61", "09.34", "44.10", "48.10", "31.50", "01.00"], "ulrich": [{"code": "4.14", "name": "Temizleme"}]},
        "Alerji (Genel)": {"source": "RAH + Ulrich", "desc": "Alerjik reaksiyonlar.", "direct": ["35.20", "64.27"], "compact": ["00.00", "01.00", "02.00", "31.10", "34.00", "35.10", "35.20", "36.00", "64.27", "31.50", "01.00"], "ulrich": [{"code": "4.01", "name": "Alerji Programı"}, {"code": "4.14", "name": "Temizleme (Clearing)"}]},
        ...
        "Anti-Aging (Gençleşme)": {"source": "Wellbeing", "desc": "Hücresel yenilenme.", "direct": ["30.65", "31.38"], "compact": ["00.00", "01.00", "02.00", "30.65", "31.38", "62.10", "62.50", "64.00", "35.10", "31.50", "01.00"], "ulrich": [{"code": "4.06", "name": "Cilt / Saç"}]},
        ...
        "Asidoz (Asitlenme)": {"source": "Ulrich", "desc": "pH dengesizliği.", "direct": ["31.53"], "compact": ["00.00", "01.00", "02.00", "31.10", "31.53", "06.00", "31.50", "01.00"], "ulrich": [{"code": "4.07", "name": "Asidoz Programı"}]},
        ...
        "Bağımlılık (Sigara/Alkol)": {"source": "RAH + Ulrich", "desc": "Bağımlılık ve detoks.", "direct": ["75.17"], "compact": ["00.00", "01.00", "02.00", "31.10", "35.10", "48.10", "50.00", "54.10", "64.28", "64.29", "72.05", "75.10", "75.17", "31.50", "01.00"], "ulrich": [{"code": "4.14", "name": "Temizleme"}]},
        ...
        "Bel Ağrısı": {"source": "RAH + Ulrich", "desc": "Bel ağrıları.", "direct": ["53.83"], "compact": ["00.00", "01.00", "02.00", "31.40", "35.10", "52.25", "53.23", "53.41", "53.73", "53.83", "31.50", "01.00"], "ulrich": [{"code": "4.21", "name": "Sırt Ağrısı"}]},
        "Borreliosis (Lyme)": {"source": "RAH + Ulrich", "desc": "Kene enfeksiyonu.", "direct": ["24.10"], "compact": ["00.00", "01.00", "02.00", "24.00", "24.10", "31.10", "35.10", "72.00", "54.00", "53.52", "31.50", "01.00"], "ulrich": [{"code": "4.01", "name": "Alerji / Enfeksiyon"}]},
        "Bronşit (Akut)": {"source": "RAH", "desc": "Akut öksürük.", "direct": ["43.13"], "compact": ["00.00", "01.00", "02.00", "31.11", "35.10", "70.17", "36.00", "42.60", "43.13", "43.30", "31.50", "01.00"]},
        "Bronşit (Kronik)": {"source": "RAH", "desc": "Uzun süreli öksürük.", "direct": ["43.14"], "compact": ["00.00", "01.00", "02.00", "31.11", "35.10", "70.17", "36.00", "42.60", "43.14", "43.30", "31.50", "01.00"]},
        "Böbrek Taşı": {"source": "RAH", "desc": "Nefrolityaz.", "direct": ["45.25"], "compact": ["00.00", "01.00", "02.00", "31.23", "35.10", "44.00", "44.21", "39.65", "45.25", "31.50", "01.00"]},
        "Böbrek Yetmezliği": {"source": "RAH", "desc": "Böbrek fonksiyon yetersizliği.", "direct": ["45.05"], "compact": ["00.00", "01.00", "02.00", "31.23", "31.87", "35.10", "44.10", "44.17", "70.21", "45.05", "45.80", "31.50", "01.00"]},
        "Cilt Mantarı": {"source": "RAH + Ulrich", "desc": "Mikoz.", "direct": ["63.50"], "compact": ["00.00", "01.00", "02.00", "30.65", "31.38", "35.10", "70.24", "62.10", "63.50", "31.50", "01.00"], "ulrich": [{"code": "4.05", "name": "Mantar Programı"}]},
        "Cilt Sorunları (Akne)": {"source": "RAH + Ulrich", "desc": "Genel cilt.", "direct": ["63.10"], "compact": ["00.00", "01.00", "02.00", "31.38", "30.65", "35.10", "70.24", "62.10", "63.10", "63.20", "31.50", "01.00"], "ulrich": [{"code": "4.06", "name": "Cilt / Saç"}]},
        "Covid-19 / Long-Covid": {"source": "RAH", "desc": "Viral sonrası.", "direct": ["43.52"], "compact": ["00.00", "01.00", "02.00", "31.11", "35.10", "22.93", "70.17", "42.70", "43.10", "43.30", "43.50", "43.52", "31.50", "01.00"], "ulrich": [{"code": "90.48", "name": "Enfeksiyon"}]},
        "Crohn Hastalığı": {"source": "RAH", "desc": "Bağırsak iltihabı.", "direct": ["47.50"], "compact": ["00.00", "01.00", "02.00", "31.12", "31.16", "31.70", "35.10", "70.19", "46.00", "47.50", "64.55", "72.00", "31.50", "01.00"]},
        "Çakra Dengeleme": {"source": "Ulrich", "desc": "Enerji merkezleri.", "direct": ["01.40"], "compact": ["00.00", "01.00", "01.40", "01.41", "01.42", "01.43", "01.44", "01.45", "01.46", "01.47", "31.50", "01.00"], "ulrich": [{"code": "4.13", "name": "Fizik Sabitleri / Çakra"}]},
        "DEHB (Dikkat Eksikliği)": {"source": "RAH + Ulrich", "desc": "Konsantrasyon.", "direct": ["55.45"], "compact": ["00.00", "01.00", "02.00", "31.10", "35.10", "35.20", "70.10", "54.00", "54.10", "55.45", "64.27", "83.80", "72.00", "31.50", "01.00"], "ulrich": [{"code": "4.04", "name": "Öğrenme Programı"}]},
        ...
        "Diş Eti İltihabı": {"source": "RAH + Ulrich", "desc": "Diş ve çene.", "direct": ["46.20"], "compact": ["00.00", "01.00", "02.00", "31.39", "46.00", "46.10", "46.20", "35.10", "31.50", "01.00"], "ulrich": [{"code": "4.11", "name": "Diş / Çene"}]},
        "Diyabet": {"source": "RAH + Ulrich", "desc": "Metabolizma.", "direct": ["51.40"], "compact": ["00.00", "01.00", "02.00", "31.14", "35.10", "70.20", "48.35", "50.20", "51.20", "51.40", "64.70", "31.50", "01.00"], "ulrich": [{"code": "4.19", "name": "Diyabet"}]},
        ...
        "Düşük Tansiyon": {"source": "RAH + Ulrich", "desc": "Hipotansiyon.", "direct": ["39.70"], "compact": ["00.00", "01.00", "02.00", "31.39", "35.10", "38.00", "39.50", "39.70", "64.00", "31.50", "01.00"], "ulrich": [{"code": "4.18", "name": "Kalp / Dolaşım"}]},
        "Elektrosmog / Radyasyon": {"source": "Ulrich + RAH", "desc": "Elektromanyetik alan.", "direct": ["22.00"], "compact": ["00.00", "01.00", "02.00", "22.00", "22.10", "22.90", "31.10", "31.50", "01.00"], "ulrich": [{"code": "4.03", "name": "Ozon / Radyasyon"}]},
        "Endometriozis": {"source": "RAH", "desc": "Rahim içi doku.", "direct": ["67.30"], "compact": ["00.00", "01.00", "02.00", "31.20", "31.22", "31.81", "35.10", "70.22", "36.10", "64.80", "65.10", "65.30", "65.31", "65.50", "66.00", "67.30", "72.00", "75.00", "31.50", "01.00"]},
        "Epstein Barr Virüsü (EBV)": {"source": "RAH", "desc": "Kronik yorgunluk.", "direct": ["16.20"], "compact": ["00.00", "01.00", "02.00", "31.10", "35.10", "16.00", "16.20", "48.10", "36.00", "31.50", "01.00"]},
        "Fibromiyalji": {"source": "RAH + Ulrich", "desc": "Yaygın ağrı.", "direct": ["53.84"], "compact": ["00.00", "01.00", "02.00", "31.38", "31.40", "35.10", "70.26", "70.27", "36.00", "52.00", "53.23", "53.25", "53.28", "53.62", "53.84", "62.10", "64.00", "31.50", "01.00"], "ulrich": [{"code": "4.13", "name": "Fizik Sabitleri"}]},
        "Fruktoz İntoleransı": {"source": "RAH", "desc": "Sindirim bozukluğu.", "direct": ["35.30"], "compact": ["00.00", "01.00", "02.00", "09.34", "31.10", "34.00", "35.10", "35.30", "46.40", "46.50", "47.70", "31.50", "01.00"]},
        "Gastrit": {"source": "RAH + Ulrich", "desc": "Mide iltihabı.", "direct": ["47.20"], "compact": ["00.00", "01.00", "02.00", "31.13", "35.10", "70.19", "46.30", "47.20", "47.10", "31.50", "01.00"], "ulrich": [{"code": "4.07", "name": "Asidoz / Mide"}]},
        "Glokom": {"source": "RAH", "desc": "Göz tansiyonu.", "direct": ["57.30"], "compact": ["00.00", "01.00", "02.00", "31.31", "35.10", "70.12", "56.00", "56.60", "57.10", "57.30", "31.50", "01.00"]},
        "Göz Kuruluğu": {"source": "RAH", "desc": "Gözyaşı kanalı.", "direct": ["57.53"], "compact": ["00.00", "01.00", "02.00", "31.31", "35.10", "70.12", "56.00", "57.53", "31.50", "01.00"]},
        ...
        "Gut": {"source": "RAH + Ulrich", "desc": "Ürik asit.", "direct": ["51.50"], "compact": ["00.00", "01.00", "02.00", "30.70", "31.10", "35.10", "50.00", "51.10", "51.50", "52.60", "71.11", "71.50", "31.50", "01.00"], "ulrich": [{"code": "4.07", "name": "Asidoz"}]},
        ...
        "Hemoroid": {"source": "RAH", "desc": "Rektal varis.", "direct": ["47.88"], "compact": ["00.00", "01.00", "02.00", "31.39", "38.50", "39.20", "39.40", "47.88", "31.50", "01.00"], "ulrich": [{"code": "4.18", "name": "Venöz Dolaşım"}]},
        "Herpes": {"source": "RAH + Ulrich", "desc": "Herpes Simplex.", "direct": ["16.50"], "compact": ["00.00", "01.00", "02.00", "31.10", "35.10", "16.50", "16.51", "63.55", "31.50", "01.00"], "ulrich": [{"code": "4.01", "name": "Enfeksiyon"}]},
        "Hormonal Denge (Kadın)": {"source": "RAH + Ulrich", "desc": "Hormon düzenleme.", "direct": ["65.10"], "compact": ["00.00", "01.00", "02.00", "31.10", "35.10", "70.22", "64.00", "65.10", "31.50", "01.00"], "ulrich": [{"code": "4.08", "name": "Kadın Hormon Programı"}]},
        "Hormonal Denge (Erkek)": {"source": "RAH + Ulrich", "desc": "Hormon düzenleme.", "direct": ["65.20"], "compact": ["00.00", "01.00", "02.00", "31.10", "35.10", "70.23", "64.00", "65.20", "31.50", "01.00"], "ulrich": [{"code": "4.09", "name": "Erkek Hormon Programı"}]},
        ...
        "Jetlag / Seyahat": {"source": "Wellbeing", "desc": "Bioritim.", "direct": ["55.20"], "compact": ["00.00", "01.00", "02.00", "01.40", "55.10", "55.20", "64.11", "31.10", "31.50", "01.00"], "ulrich": [{"code": "4.13", "name": "Fizik Sabitleri"}]},
        "Kabızlık": {"source": "RAH", "desc": "Bağırsak hareketliliği.", "direct": ["47.86"], "compact": ["00.00", "01.00", "02.00", "31.12", "31.16", "35.10", "70.19", "46.00", "47.86", "31.50", "01.00"]},
        ...
        "Katarakt": {"source": "RAH", "desc": "Göz merceği.", "direct": ["57.20"], "compact": ["00.00", "01.00", "02.00", "31.31", "35.10", "70.12", "56.00", "56.40", "57.20", "31.50", "01.00"]},
        "Kemik Kırığı": {"source": "RAH", "desc": "Kırık iyileşmesi.", "direct": ["53.11"], "compact": ["00.00", "01.00", "02.00", "31.39", "31.41", "35.10", "70.51", "52.00", "53.11", "31.50", "01.00"]},
        ...
        "Kilo Verme": {"source": "RAH + Ulrich", "desc": "Metabolizma.", "direct": ["75.15"], "compact": ["00.00", "01.00", "02.00", "09.00", "31.10", "36.00", "38.00", "44.00", "46.40", "48.10", "50.00", "64.00", "75.10", "75.15", "31.50", "01.00"], "ulrich": [{"code": "4.19", "name": "Diyabet / Metabolizma"}]},
        ...
        "Kronik Yorgunluk": {"source": "RAH + Ulrich", "desc": "Sürekli yorgunluk.", "direct": ["16.20"], "compact": ["00.00", "01.00", "02.00", "31.10", "35.10", "16.20", "48.10", "70.10", "31.50", "01.00"], "ulrich": [{"code": "4.16", "name": "Kundalini"}]},
        "Menisküs / Diz": {"source": "RAH", "desc": "Diz eklemi.", "direct": ["53.51"], "compact": ["00.00", "01.00", "02.00", "31.39", "31.41", "35.10", "52.00", "52.60", "53.51", "31.50", "01.00"], "ulrich": [{"code": "4.13", "name": "Fizik Sabitleri"}]},
        "Menopoz": {"source": "RAH + Ulrich", "desc": "Klimakterik.", "direct": ["65.60"], "compact": ["00.00", "01.00", "02.00", "31.10", "35.10", "70.22", "64.10", "64.20", "65.10", "65.60", "66.00", "72.00", "75.00", "31.50", "01.00"], "ulrich": [{"code": "4.08", "name": "Kadın Hormon"}]},
        "Migren": {"source": "RAH + Ulrich", "desc": "Baş ağrısı.", "direct": ["55.60"], "compact": ["00.00", "01.00", "02.00", "31.10", "35.10", "70.45", "38.10", "39.10", "39.40", "54.10", "54.25", "55.55", "55.60", "64.00", "72.05", "31.50", "01.00"], "ulrich": [{"code": "4.40", "name": "Migren"}]},
        "Operasyon Sonrası": {"source": "Dr. Ulrich", "desc": "İyileşme.", "direct": ["70.63"], "compact": ["00.00", "01.00", "31.80", "31.81", "31.82", "70.63", "35.10", "31.50", "01.00"], "ulrich": [{"code": "4.10", "name": "Op. Sonrası"}]},
        ...
        "Otizm Spektrum": {"source": "RAH + Ulrich", "desc": "Detoks ve öğrenme.", "direct": ["31.60", "47.00"], "compact": ["00.00", "01.00", "02.00", "31.60", "31.50", "47.00", "54.00", "35.10", "31.50", "01.00"], "ulrich": [{"code": "4.14", "name": "Temizleme"}, {"code": "4.04", "name": "Öğrenme"}]},
        "Panik Atak": {"source": "RAH + Ulrich", "desc": "Korku.", "direct": ["72.05"], "compact": ["00.00", "01.00", "02.00", "31.10", "72.05", "75.10", "54.00", "64.10", "31.50", "01.00"], "ulrich": [{"code": "4.02", "name": "Stres"}]},
        "Parkinson": {"source": "RAH + Ulrich", "desc": "Hareket bozukluğu.", "direct": ["55.31"], "compact": ["00.00", "01.00", "02.00", "31.34", "31.35", "35.10", "70.68", "38.10", "54.00", "55.31", "64.28", "72.00", "75.10", "31.50", "01.00"], "ulrich": [{"code": "4.17", "name": "Parkinson"}]},
        "Prostat": {"source": "RAH + Ulrich", "desc": "Prostatit.", "direct": ["69.30"], "compact": ["00.00", "01.00", "02.00", "31.18", "35.10", "70.23", "68.26", "69.10", "69.30", "31.50", "01.00"], "ulrich": [{"code": "4.09", "name": "Erkek Hormon"}]},
        "Radyasyon / 5G": {"source": "Ulrich + RAH", "desc": "Elektrosmog.", "direct": ["22.00"], "compact": ["00.00", "01.00", "02.00", "22.00", "22.10", "22.90", "31.10", "31.50", "01.00"], "ulrich": [{"code": "4.03", "name": "Ozon / Radyasyon"}]},
        "Reflü": {"source": "RAH + Ulrich", "desc": "Mide asidi.", "direct": ["47.10"], "compact": ["00.00", "01.00", "02.00", "30.90", "31.10", "35.10", "46.20", "47.10", "70.19", "31.50", "01.00"], "ulrich": [{"code": "4.07", "name": "Asidoz"}]},
        "Romatizma": {"source": "RAH + Ulrich", "desc": "Eklem ağrısı.", "direct": ["53.52"], "compact": ["00.00", "01.00", "02.00", "31.40", "31.41", "35.10", "70.28", "52.00", "53.52", "53.53", "53.54", "31.50", "01.00"], "ulrich": [{"code": "4.13", "name": "Fizik Sabitleri"}]},
        "Sedef": {"source": "RAH + Ulrich", "desc": "Psoriasis.", "direct": ["63.10"], "compact": ["00.00", "01.00", "02.00", "31.38", "30.65", "35.10", "70.24", "62.10", "62.20", "62.60", "63.10", "72.00", "75.00", "31.50", "01.00"], "ulrich": [{"code": "4.06", "name": "Cilt"}]},
        "Selülit": {"source": "Wellbeing", "desc": "Bağ dokusu.", "direct": ["62.50"], "compact": ["00.00", "01.00", "02.00", "31.52", "36.00", "37.10", "62.50", "50.00", "31.50", "01.00"], "ulrich": [{"code": "4.07", "name": "Asidoz"}, {"code": "4.14", "name": "Detoks"}]},
        "Sigara Bırakma": {"source": "RAH + Ulrich", "desc": "Nikotin detoksu.", "direct": ["75.16"], "compact": ["00.00", "01.00", "02.00", "31.10", "35.10", "75.16", "75.17", "48.10", "31.50", "01.00"], "ulrich": [{"code": "4.14", "name": "Temizleme"}]},
        "Sınav Stresi": {"source": "Wellbeing + Ulrich", "desc": "Odaklanma.", "direct": ["54.00"], "compact": ["00.00", "01.00", "02.00", "31.10", "54.00", "54.10", "35.20", "64.27", "83.80", "31.50", "01.00"], "ulrich": [{"code": "4.04", "name": "Öğrenme"}]},
        "Sinüzit (Kronik)": {"source": "RAH", "desc": "Sinüs iltihabı.", "direct": ["43.16"], "compact": ["00.00", "01.00", "02.00", "31.25", "35.10", "70.16", "36.00", "42.10", "42.20", "43.11", "43.16", "31.50", "01.00"], "ulrich": [{"code": "4.01", "name": "Enfeksiyon"}]},
        "Sırt Ağrısı": {"source": "RAH + Ulrich", "desc": "Omurga.", "direct": ["53.70"], "compact": ["00.00", "01.00", "02.00", "31.40", "35.10", "71.11", "71.50", "52.00", "52.20", "53.23", "53.25", "53.41", "53.70", "72.05", "75.10", "31.50", "01.00"], "ulrich": [{"code": "4.21", "name": "Sırt Ağrısı"}]},
        "Spor Yaralanması": {"source": "RAH + Ulrich", "desc": "Travma.", "direct": ["53.21"], "compact": ["00.00", "01.00", "02.00", "31.39", "31.40", "35.10", "53.21", "53.22", "53.24", "31.50", "01.00"], "ulrich": [{"code": "4.22", "name": "Skar/Yara"}]},
        "Stres": {"source": "RAH + Ulrich", "desc": "Gerginlik.", "direct": ["75.10"], "compact": ["00.00", "01.00", "02.00", "31.10", "48.10", "50.00", "64.05", "64.10", "64.20", "64.28", "64.29", "64.30", "64.35", "64.40", "64.50", "72.05", "75.10", "31.50", "01.00"], "ulrich": [{"code": "4.02", "name": "Stres"}]},
        "Tinnitus": {"source": "RAH + Ulrich", "desc": "Kulak çınlaması.", "direct": ["59.10"], "compact": ["00.00", "01.00", "02.00", "31.10", "35.10", "70.15", "38.10", "39.10", "58.30", "58.40", "59.10", "59.40", "72.00", "75.00", "31.50", "01.00"], "ulrich": [{"code": "4.12", "name": "Tinnitus"}]},
        "Tiroid": {"source": "RAH + Ulrich", "desc": "Dengesizlik.", "direct": ["65.33"], "compact": ["00.00", "01.00", "02.00", "31.33", "35.10", "70.54", "64.10", "64.20", "64.30", "65.30", "31.50", "01.00"], "ulrich": [{"code": "4.08", "name": "Hormon"}]},
        "Uyku Apnesi": {"source": "RAH 42.50", "desc": "Solunum durması.", "direct": ["42.50"], "compact": ["00.00", "01.00", "02.00", "31.11", "42.00", "42.50", "42.60", "54.00", "31.50", "01.00"], "ulrich": [{"code": "4.20", "name": "Astım"}]},
...
def main():
    ...
    if selected_disease:
        ...
        with tab1:
            ...
            st.markdown("---")
            with st.expander("📋 Uygulama Adımları ve WhatsApp Paylaşımını Aç", expanded=False):
