...
# =============================================================================
# 1. GÖRSEL TASARIM (CSS - MOBİL KLAVYE & DARK MODE FIX)
# =============================================================================
def local_css():
    st.markdown("""
    <style>
    ...
    /* --- 2. MOBİL İÇİN KRİTİK AYARLAR (GERİ EKLENDİ!) --- */
    @media only screen and (max-width: 600px) {
        .header-container { padding: 1rem !important; }
        .header-title { font-size: 1.4rem !important; }
        
        /* Menü açıldığında ekranı kaplamasın, kaydırılabilsin */
        ul[data-baseweb="menu"] {
            max-height: 200px !important;
            overflow-y: auto !important;
        }
        /* KLAVYE SORUNU ÇÖZÜMÜ: Görünmez boşluk */
        .spacer-div {
    ...
    /* --- 3. GİRİŞ KUTULARI (SİYAH EKRAN SORUNU ÇÖZÜMÜ) --- */
...
# =============================================================================
# 2. VERİTABANI (EKSİKSİZ TAM LİSTE - v26.0)
# =============================================================================
def get_rah_database():
    db = {
        ...
        "Gastrit / Mide Yanması": {"source": "RAH + Ulrich", "desc": "Mide mukozası iltihabı ve reflü.", "direct": ["47.20"], "compact": ["00.00", "01.00", "02.00", "31.13", "35.10", "70.19", "46.30", "47.20", "47.10", "31.50", "01.00"], "ulrich": [{"code": "4.07", "name": "Asidoz / Mide"}]},
        ...
        "Hormonal Denge (Erkek)": {"source": "RAH + Ulrich", "desc": "Genel hormon düzenleme.", "direct": ["65.20"], "compact": ["00.00", "01.00", "02.00", "31.10", "35.10", "70.23", "64.00", "65.20", "31.50", "01.00"], "ulrich": [{"code": "4.09", "name": "Erkek Hormonları"}]},
        ...
        "Radyasyon / 5G Koruma": {"source": "Ulrich + RAH", "desc": "Elektromanyetik alan yüklemesi.", "direct": ["22.00"], "compact": ["00.00", "01.00", "02.00", "22.00", "22.10", "22.90", "31.10", "31.50", "01.00"], "ulrich": [{"code": "4.03", "name": "Ozon / Radyasyon Koruma"}]},
        ...
        "Tiroid (Dengesizlik)": {"source": "RAH + Ulrich", "desc": "Hipotiroidi veya Hipertiroidi.", "direct": ["65.33"], "compact": ["00.00", "01.00", "02.00", "31.33", "35.10", "70.54", "64.10", "64.20", "64.30", "65.30", "31.50", "01.00"], "ulrich": [{"code": "4.08", "name": "Hormon Programı"}]},
        "Uyku Bozukluğu": {"source": "RAH + Ulrich", "desc": "Uykuya dalma ve sürdürme.", "direct": ["55.10"], "compact": ["00.00", "01.00", "02.21", "31.10", "35.10", "70.10", "54.00", "55.10", "64.11", "65.30", "72.00", "75.10", "31.50", "01.00"], "ulrich": [{"code": "4.02", "name": "Stres (Uyku Öncesi)"}]},
