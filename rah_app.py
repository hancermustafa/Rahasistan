...
# =============================================================================
# 1. GÖRSEL TASARIM (CSS - ENTEGRE LOGO & HEADER)
# =============================================================================
def local_css():
    st.markdown("""
    <style>
    ...
    .header-container {
        ...
        gap: 20px; /* Logo ile yazı arası boşluk */
    }
    ...
    .header-logo {
        ...
        flex-shrink: 0; /* Logunun sıkışmasını engeller */
    }
    ...
    .whatsapp-btn {
        ...
        text-decoration: none; font-weight: bold; text-align: center; margin-top: 10px; box-shadow: 0 4px 6px rgba(0,0,0,0.1); transition: all 0.2s;
    }
    ...
    div[role="radiogroup"] label {
        background-color: white; padding: 5px 15px; border-radius: 20px; border: 1px solid #ddd; cursor: pointer; transition: all 0.2s;
    }
    ...
    .stTabs [data-baseweb="tab"] {
        height: auto; min-height: 40px; background-color: #f1f2f6 !important; color: #57606f !important; border-radius: 6px 6px 0 0;
        font-weight: 600; border: 1px solid #e0e0e0; border-bottom: none; padding: 8px 10px; flex-grow: 1; text-align: center;
    }
...
# =============================================================================
# 2. HELPER FONKSİYON (LOGO İÇİN BASE64)
# =============================================================================
...
def get_rah_database():
    db = {
        ...
        "Ağır Metal Detoksu": {"source": "RAH + Ulrich 4.14", "desc": "Vücuttan ağır metallerin atılımı.", "direct": ["31.60", "31.50"], "compact": ["00.00", "01.00", "02.00", "31.10", "31.50", "31.60", "31.61", "09.34", "44.10", "48.10", "31.50", "01.00"], "ulrich": [{"code": "4.14", "name": "Temizleme"}]},
        ...
        "Anti-Aging (Gençleşme)": {"source": "Wellbeing + RAH", "desc": "Hücresel yenilenme.", "direct": ["30.65", "31.38"], "compact": ["00.00", "01.00", "02.00", "30.65", "31.38", "62.10", "62.50", "64.00", "35.10", "31.50", "01.00"], "ulrich": [{"code": "4.06", "name": "Cilt / Saç"}]},
        ...
        "Bel Ağrısı (Lumbago)": {"source": "RAH + Ulrich", "desc": "Bel ağrıları.", "direct": ["53.83"], "compact": ["00.00", "01.00", "02.00", "31.40", "35.10", "52.25", "53.23", "53.41", "53.73", "53.83", "31.50", "01.00"], "ulrich": [{"code": "4.21", "name": "Sırt Ağrısı"}]},
...
def get_program_name(code):
    names = {
        ...
        "31.50": "Temel Detoks", "31.51": "Detoks Kan", "31.52": "Detoks Lenf", "31.53": "Detoks Bağ Dokusu", "31.60": "Detoks Karaciğer", "31.61": "Ağır Metal Detoksu", "31.81": "Yara İzi Tedavisi",
        "35.10": "Bağışıklık Artırma", "35.20": "Alerji Temel", "35.30": "Fruktoz İntoleransı",
    ...
    with c1:
        ...
        try:
            if os.path.exists("drsaitlogo.jpeg"):
                with open("drsaitlogo.jpeg", "rb") as f:
                    img_data = f.read()
                b64_img = base64.b64encode(img_data).decode()
                st.markdown(f'<img src="data:image/jpeg;base64,{b64_img}" class="header-logo">', unsafe_allow_html=True)
        except: pass
    ...
    with c2:
        ...
        <div class="header-container">
            <div class="header-text-block">
                <div class="header-title">Dr. Sait SEVİNÇ</div>
                <div class="header-subtitle">RAH Asist</div>
            </div>
        </div>
        """, unsafe_allow_html=True)
